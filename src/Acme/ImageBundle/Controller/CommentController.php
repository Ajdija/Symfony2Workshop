...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ImageBundle:Comment')->findAll();
     ...
     * @Method("POST")
     * @Template("ImageBundle:Comment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImageBundle:Comment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ImageBundle:Comment:edit.html.twig")
     */
